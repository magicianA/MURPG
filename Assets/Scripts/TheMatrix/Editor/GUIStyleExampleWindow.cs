...
public sealed class GUIStyleExampleWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        for (int i = page * itemsPerPage; i < mList.Length && i < (page + 1) * itemsPerPage; ++i)
        {
            EditorGUILayout.BeginHorizontal(GUILayout.Height(48));
            EditorGUILayout.SelectableLabel(mList[i]);
            EditorGUILayout.LabelField(text, new GUIStyle(mList[i]));
        ...
        {
            page++;
            while (page * itemsPerPage > mList.Length) page--;
        }
